...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # Forward pass
        hidden_layer = np.maximum(0, X_flat.dot(W1) + b1)  # ReLU activation
        scores = hidden_layer.dot(W2) + b2  # Second layer scores
        ...
        dhidden[hidden_layer <= 0] = 0  # Backprop through ReLU
